...
/* PRE-INITIALISATION
*/
//File.WriteAllText($"{Config.PathOfProgram}Log.txt", $"{System.DateTime.Now} : Starting Pre-Initialisation\n");
...
string[] files = Directory.GetFiles(Config.PathOfProgram + "/Data", "*.*fits", SearchOption.AllDirectories);
